const baseUrl = '/api/v1/auth/read';
    ...
    notes.forEach((note, index) => {
      ...
      row.innerHTML = `
        ...
        <td class="p-4 text-sm font-normal text-gray-500 whitespace-nowrap dark:text-gray-400">
          <div class="text-base font-semibold text-gray-900 dark:text-white">${truncateText(note.userID.name, 30)}</div>
          <div class="text-sm font-normal text-gray-500 dark:text-gray-400">${truncateText(note.userID.email, 30)}</div>
        </td>
        <td class="p-4 text-sm font-normal text-gray-500 whitespace-nowrap dark:text-gray-400">
